...
<html lang="en">
  ...
  <div class="container">
    <a class="navbar-brand" href="#">Pondok Modern Darussalam Gontor</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class ="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link" href="proses-pendaftaran.php">Pendaftar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="form-daftar.php">Daftar Baru</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="list-siswa.php">List</a>
        </li>
        <li class="nav-item">
...
<p align="center">Copyright@Reni Try Setianingsih</p>
